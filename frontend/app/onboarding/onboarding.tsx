...
const InitPage = ({
    ...
    const label = telemetryEnabled ? t("common.enabled") : t("common.disabled");
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            >
                ...
                <div className="text-center text-[25px] font-normal text-foreground">{t("onboarding.welcome")}</div>
            </header>
                ...
                <div className="flex flex-col items-start gap-8 w-full mb-5 unselectable">
                    <div className="flex w-full items-center gap-[18px]">
                        ...
                        <div className="flex flex-col items-start gap-1 flex-1">
                            <div className="text-foreground text-base leading-[18px]">{t("onboarding.supportUs")}</div>
                            <div className="text-secondary leading-5">
                                <Trans
                                    i18nKey="onboarding.supportDesc"
                                    components={[
                                        <i key="0" />,
                                        <i key="1" />,
                                        <a key="2" target="_blank" href="https://github.com/wavetermdev/waveterm?ref=install" rel="noopener" className="text-accent" onClick={handleStarClick} />,
                                    ]}
                                />
                            </div>
                        </div>
    ...
    return (
        <div className="flex flex-col h-full">
            <header className={`flex flex-col gap-2 border-b-0 p-0 mt-1 mb-4 w-full unselectable flex-shrink-0`}>
                ...
                <div className="text-center text-[25px] font-normal text-foreground">{t("onboarding.telemetryDisabled")}</div>
            </header>
            <OverlayScrollbarsComponent
                className="flex-1 overflow-y-auto min-h-0"
                options={{ scrollbars: { autoHide: "never" } }}
            >
                <div className="flex flex-col items-center gap-6 w-full mb-2 unselectable">
                    <div className="text-center text-secondary leading-relaxed max-w-md">
                        <p className="mb-4">{t("onboarding.noProblem")}</p>
